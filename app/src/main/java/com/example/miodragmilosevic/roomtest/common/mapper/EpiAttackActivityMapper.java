...
public class EpiAttackActivityMapper extends BaseUiListItemMapper<EpiAttackActivity> {

    public EpiAttackActivityMapper(Context c) {
        super(c);
    }

    @Override
    public BaseUiListItem map(EpiAttackActivity item) {
    ...
    @Override
    public EpiAttackActivity reverseMap(BaseUiListItem item) {
        return null;
    }
}
