...
public class AdjustAttackTypeSettingsItemMapper extends BaseSettingsItemMapper<EpiAttackType> {

    public AdjustAttackTypeSettingsItemMapper(Context c) {
        super(c);
    }
    ...
    @Override
    public EpiAttackType reverseMap(BaseSettingsItem item) {
        return new EpiAttackType(item.getName(), false);
